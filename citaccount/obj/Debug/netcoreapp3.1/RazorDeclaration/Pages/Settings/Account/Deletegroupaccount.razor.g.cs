#pragma checksum "D:\Projects\citaccount\citaccount\Pages\Settings\Account\Deletegroupaccount.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ed5954f3b66145c3fb70f2dd5cd2ae380db42025"
// <auto-generated/>
...
#nullable disable
#nullable restore
#line 3 "D:\Projects\citaccount\citaccount\Pages\Settings\Account\Deletegroupaccount.razor"
...
#nullable disable
#nullable restore
#line 4 "D:\Projects\citaccount\citaccount\Pages\Settings\Account\Deletegroupaccount.razor"
using citaccount.Service;

#line default
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/deletegroupaccount/{currentId}")]
    public partial class Deletegroupaccount : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 31 "D:\Projects\citaccount\citaccount\Pages\Settings\Account\Deletegroupaccount.razor"
        ...
        {
            settingService.DeleteGroupAcc(gracc);
            nav.NavigateTo("groupaccount");
            toastService.ShowWarning($"ທ່ານໄດ້ລຶບຂໍ້ມູນ {gracc.Name} ສຳເລັດແລ້ວ!", "ກູ່ມບັນຊີ");
        }
        void goBack()
        {
            nav.NavigateTo("groupaccount");
